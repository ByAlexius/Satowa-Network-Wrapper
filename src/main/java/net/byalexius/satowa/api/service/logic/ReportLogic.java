package net.byalexius.satowa.api.service.logic;

import com.google.gson.JsonArray;
import com.google.gson.JsonElement;
import com.google.gson.JsonParser;
import net.byalexius.satowa.api.internal.common.Constants;
import net.byalexius.satowa.api.internal.helper.LoggingHelper;
import net.byalexius.satowa.api.internal.model.ReportModel;
...
/**
 * Contains the logic for the {@link } Implementation
...
public class ReportLogic {
     ...
     * @return a List of {@link ReportModel}'s
     */
    public List<ReportModel> getReports(String apiKey, long id, String reporter_Id, String reported_Id, Constants.Platform platform, Boolean status, boolean getAll) {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.isSuccessful()) {
                ...
                LoggingHelper.error(this.getClass(), "Request was not successful. Response code: " + response.code());
            }
        } catch (IOException e) {
            LoggingHelper.error(this.getClass(), e);
        }
